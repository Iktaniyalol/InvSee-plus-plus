...
class SetupImpl implements Setup {
    ...
    static {
        ...
        SUPPORTED.registerSupportedVersion(() -> new Impl_1_21_7(), ServerSoftware.CRAFTBUKKIT_1_21_7, new ServerSoftware(MinecraftPlatform.PAPER, MinecraftVersion._1_21_7));
